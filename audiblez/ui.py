...
class MainWindow(wx.Frame):
    ...
    def create_params_panel(self):
        ...
        self.min_tokens_ctrl = wx.SpinCtrl(panel, min=10, max=500, initial=10)
        ideal_tokens_label = wx.StaticText(panel, label="Ideal tokens:")
        self.ideal_tokens_ctrl = wx.SpinCtrl(panel, min=10, max=500, initial=25)
        max_tokens_label = wx.StaticText(panel, label="Max tokens:")
        self.max_tokens_ctrl = wx.SpinCtrl(panel, min=10, max=500, initial=40)
